...
const Roulette = () => {
  ...
  return (
    <div className="relative flex justify-center md:justify-start">
      ...
      ></iframe>
      <div className="absolute bg-accentColor rounded-md h-[65px] w-[320px] bottom-0 flex items-center justify-center select-none">
        <span className="text-black font-bold text-xl">Lucky Spin</span>
      </div>
