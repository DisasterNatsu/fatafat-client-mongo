...
const InformationTable = () => {
  return (
    <div className="p-4">
      <h3 className="text-xl font-medium text-center text-black bg-accentColor cursor-default py-1">
        ...
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell className="text-center w-[70%] text-sm">
              Kolkata Fatafat | कोलकाता फटाफट | কলকাতা ফটাফট
            </TableCell>
          </TableRow>
          ...
          <TableRow>
            ...
            <TableCell className="text-center text-sm">1951</TableCell>
          </TableRow>
